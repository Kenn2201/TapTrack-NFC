...
- **Active Development**: `v0.5.0 ALPHA (In Development)` (Branch: `kenn/develop`)
- **Milestone Scope**: Universal NFC URL /t#token fallback
...
| v0.5.0 | ALPHA | Universal NFC URL /t#token fallback | In Development |
